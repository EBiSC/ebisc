...
class Cellline(models.Model):
    ...
    celllinenamesynonyms = models.TextField(_(u'Celllinenamesynonyms'), null=True, blank=True)
    depositorscelllineuri = models.CharField(_(u'Depositorscelllineuri'), max_length=45, blank=True)
    celllinecomments = models.TextField(_(u'Celllinecomments'), null=True, blank=True)
    ...
    celllineecaccurl = models.URLField(_(u'Celllineecaccurl'), blank=True, null=True)
...
class Celllineannotation(models.Model):
    ...
    celllineannotation = models.TextField(_(u'Celllineannotation'), null=True, blank=True)
...
class Celllinederivation(models.Model):
    ...
    selectioncriteriaforclones = models.TextField(_(u'Selectioncriteriaforclones'), null=True, blank=True)
...
class Celllinegenotypingother(models.Model):
    ...
    celllinegenotypingother = models.TextField(_(u'Celllinegenotypingother'), null=True, blank=True)
...
class Celllinelegal(models.Model):
    ...
    q6restrictions = models.TextField(_(u'Q6restrictions'), null=True, blank=True)
    q7iprestrictions = models.TextField(_(u'Q7iprestrictions'), null=True, blank=True)
    q8jurisdiction = models.ForeignKey('Country', blank=True, null=True)
    q9applicablelegislationandregulation = models.TextField(_(u'Q9applicablelegislationandregulation'), null=True, blank=True)
    q10managedaccess = models.TextField(_(u'Q10managedaccess'), null=True, blank=True)
...
class Celllinepublication(models.Model):
    ...
    celllinepublicationdoiurl = models.URLField(_(u'Celllinepublicationdoiurl'), blank=True, null=True)
